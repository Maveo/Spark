...
welcome_image = ImageStackResolveString('''<image x="0" y="0" width="600" height="324" xlink:href="{{'https://raw.githubusercontent.com/Maveo/Spark/v1.3.1/images/welcome_template.png' | web_image}}"/>
