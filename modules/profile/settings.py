...
<rect id="background" x="0" y="0" width="600" height="150" rx="20" ry="20" fill="rgb(48, 50, 55)" />
<image x="15" y="15" width="120" height="120" xlink:href="{{ avatar_url | web_image }}"/>
<path id="background2" fill-rule="evenodd" fill="rgb(48, 50, 55)" d="m15,15 l120,0 l0,120 l-120,0 l0,-120 m60,0 a60,60 0 0 0 -60 60 a60,60 0 0 0 60 60 a60,60 0 0 0 60 -60 a60,60 0 0 0 -60 -60" />
<image id="userEmoji" x="147" y="15" width="40" height="40" xlink:href="{{ member.top_role.name[0] | emoji }}"/>
<rect id="xpBackground" x="150" y="115" width="430" height="20" rx="10" ry="10" fill="rgb(87, 87, 87)" />
